# 06 · Módulo R — Reemplazo / Extracción (absorbe Calibración)

> Ref: [processor_documentation §8](../../flows/processor_documentation.md) ·
> `processor.py` L1631-2913. Es el **módulo más complejo**: modelo bifásico
> (`alcance_R`) × dos subtrabajos (`R_type = ['E','I']`) × subdestinos.
> Absorbió el antiguo módulo CI (Calibración).
...
Un reemplazo es un **par**: la pieza que sale (`t='E'`) y la que entra (`t='I'`).
La rama depende de `alcance_R` y, para E, de `destino_R`.
